...
from .models import Question, Player, AnsweredQuestions, PlayerFollowing, MovieInfo
...
def home(request):
    ...
    for player in players:
        if player.username == author:
            ...
            return render(request, "home/home.html", {"feed": reversed(feed), "person": author, "feed2": reversed(feed2), "present": True, 'all_players': players})
